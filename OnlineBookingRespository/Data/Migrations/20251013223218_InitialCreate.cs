        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationInMinutes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedDurationMinutes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorScheduleService", x => new { x.DoctorSchedulesId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_DoctorScheduleService_DoctorSchedules_DoctorSchedulesId",
                        column: x => x.DoctorSchedulesId,
                        principalTable: "DoctorSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorScheduleService_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorScheduleService_ServicesId",
                table: "DoctorScheduleService",
                column: "ServicesId");
